...
@interface TYGDeviceDataLibrery()

@property (nonatomic, assign) DiviceType iDevice;

@end

@implementation TYGDeviceDataLibrery

#pragma mark - Public Method

+(instancetype)sharedLibrery {
    static TYGDeviceDataLibrery *_librery;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _librery = [[TYGDeviceDataLibrery alloc] init];
