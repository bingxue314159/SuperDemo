...
#import "MGSwipeTableCellDemo.h"
#import "MGSwipeTableCellDemoTestData.h"
#import "MGSwipeButton.h"

#define TEST_USE_MG_DELEGATE 1

@implementation MGSwipeTableCellDemo
{
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (buttonIndex == 1) {
        tests = [MGSwipeTableCellDemoTestData data];
        ...
        if (background) {
            ...
            background = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MGSwipeBackground.jpg"]];
        ...
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"MGSwipeTableCellDemo" bundle:nil];
        MGSwipeTableCellDemo *vc = [sb instantiateInitialViewController];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MGSwipeTableCellDemoTestData * data = [tests objectAtIndex:indexPath.row];
...
{
    MGSwipeTableCellDemoTestData * data = [tests objectAtIndex:[_tableView indexPathForCell:cell].row];
