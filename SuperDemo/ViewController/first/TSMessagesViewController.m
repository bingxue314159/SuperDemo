...
#import "TSMessagesViewController.h"
#import "TSMessage.h"

@interface TSMessagesViewController ()<TSMessageViewProtocol>

@end

@implementation TSMessagesViewController
