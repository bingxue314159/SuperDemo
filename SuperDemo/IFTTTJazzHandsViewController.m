...
- (void)configureViews
{
    ...
    self.iftttPresents = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-IFTTTPresents"]];
    [self.contentView addSubview:self.iftttPresents];
    
    self.blueStick = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-BlueStick"]];
    [self.contentView addSubview:self.blueStick];
    
    self.orangeStick = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-OrangeStick"]];
    [self.contentView addSubview:self.orangeStick];
    
    self.jazz = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-Jazz"]];
    [self.contentView addSubview:self.jazz];
    
    self.hands = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-Hands"]];
    ...
    self.musicNotes = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-MusicNotes"]];
    [self.contentView addSubview:self.musicNotes];
    
    self.sun = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-Sun"]];
    [self.contentView addSubview:self.sun];

    self.bigCloud = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-BigCloud"]];
    [self.contentView addSubview:self.bigCloud];
    
    self.littleCloud = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-LittleCloud"]];
    [self.contentView addSubview:self.littleCloud];
    
    self.iftttCloud = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-IFTTTCloud"]];
    [self.contentView addSubview:self.iftttCloud];

    self.page2Text = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-Page2Text"]];
    [self.contentView addSubview:self.page2Text];

    self.page3Text = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JazzHands-Page3Text"]];
