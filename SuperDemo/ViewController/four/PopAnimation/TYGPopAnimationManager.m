...
@implementation TYGPopAnimationManager
...
+(void)springPopViewConfigAnimation:(POPPropertyAnimation *)animation WithType:(NSString *)type andAnimated:(BOOL)animated{
    //For scale
    if ([type isEqualToString:kPOPViewScaleXY]) {
        if (animated) {
    ...
    else if ([type isEqualToString:kPOPViewScaleX]){
        if (animated) {
    ...
    else if ([type isEqualToString:kPOPViewScaleY]){
        if (animated) {
            animation.toValue = @(2.0);
        }else{
            animation.toValue = @(1.0);
    ...
    else if ([type isEqualToString:kPOPViewBackgroundColor]){
        if (animated) {
    ...
    else if ([type isEqualToString:kPOPViewTintColor]){
        if (animated) {
            animation.toValue = [UIColor purpleColor];
        }else{
            animation.toValue = [UIColor colorWithRed:0.16 green:0.72 blue:1 alpha:1];
    ...
    else if ([type isEqualToString:kPOPViewBounds]){
        if (animated) {
    ...
    else if ([type isEqualToString:kPOPViewFrame]){
        if (animated) {
            animation.toValue = [NSValue valueWithCGRect:CGRectMake(0, 0, 30, 30)];
        }else{
            animation.toValue = [NSValue valueWithCGRect:CGRectMake(0, 0, 150, 150)];
    ...
    else if ([type isEqualToString:kPOPViewAlpha]){
        if (animated) {
            animation.toValue = @0;
        }else{
            animation.toValue = @1.0;
    ...
    else if ([type isEqualToString:kPOPViewCenter]){
        if (animated) {
    ...
    else if ([type isEqualToString:kPOPViewSize]){
