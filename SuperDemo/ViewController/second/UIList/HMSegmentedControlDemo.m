...
#import "HMSegmentedControlDemo.h"

@interface HMSegmentedControlDemo ()
...
@implementation HMSegmentedControlDemo
...
- (void)viewDidLoad {
    ...
    HMSegmentedControl *segmentedControl2 = [[HMSegmentedControl alloc] initWithSectionImages:@[[UIImage imageNamed:@"HMSeg-1"], [UIImage imageNamed:@"HMSeg-2"], [UIImage imageNamed:@"HMSeg-3"], [UIImage imageNamed:@"HMSeg-4"]] sectionSelectedImages:@[[UIImage imageNamed:@"HMSeg-1-selected"], [UIImage imageNamed:@"HMSeg-2-selected"], [UIImage imageNamed:@"HMSeg-3-selected"], [UIImage imageNamed:@"HMSeg-4-selected"]]];
