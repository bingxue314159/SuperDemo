...
@implementation TYGDeviceInfo


+ (instancetype)sharedManager {
    static TYGDeviceInfo *_manager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _manager = [[TYGDeviceInfo alloc] init];
    });
    return _manager;
}
...
- (NSString *)getCPUProcessor {
    return [[TYGDeviceDataLibrery sharedLibrery] getCPUProcessor] ? : @"unKnown";
}
