...
#import "ASProgressPopUpViewDemo.h"

@interface ASProgressPopUpViewDemo ()<ASProgressPopUpViewDataSource>

@end

@implementation ASProgressPopUpViewDemo{
    NSTimer *_timer;
}
